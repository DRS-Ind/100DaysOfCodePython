...
class FlightData:
    ...
    def __init__(self, price, origin_airport, destination_airport, out_date, return_date, stops):
        ...
        - stops: The amount of stops ofr the flight.
        """
        self.price = price
...
def find_cheapest_flight(data):
    ...
    stop_counter = len(first_flight["itineraries"][0]["segments"]) - 1
    origin = first_flight["itineraries"][0]["segments"][0]["departure"]["iataCode"]
    destination = first_flight["itineraries"][0]["segments"][stop_counter]["arrival"]["iataCode"]
    out_date = first_flight["itineraries"][0]["segments"][0]["departure"]["at"].split("T")[0]
    return_date = first_flight["itineraries"][1]["segments"][0]["departure"]["at"].split("T")[0]

    # Initialize FlightData with the first flight for comparison
    cheapest_flight = FlightData(lowest_price, origin, destination, out_date, return_date, stop_counter)
    ...
    for flight in data["data"]:
        ...
        if price < lowest_price:
            ...
            destination = flight["itineraries"][0]["segments"][stop_counter]["arrival"]["iataCode"]
