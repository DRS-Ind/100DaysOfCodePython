...
def post(post_id: int):
    ...
    :param post_id: the post id number
    """
    # catch the wrong post
    try:
...
def receive_form_data():
    """
    The POST method catch form values and send the message with them.
    """
    ...
    # catch error with connection to the SMTP server
    try:
